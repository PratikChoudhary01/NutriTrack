...
foodimg_dir = 'E:\\Certificate\\Cources\\code\\Recommendationsystem\\dataset\\Indian Food Images'
nutrition_data = pd.read_csv('E:\\Certificate\\Cources\\code\\Recommendationsystem\\dataset\\new_cal.csv')

# Ensure column names are clean
nutrition_data.columns = nutrition_data.columns.str.strip()

# Load the model
model = load_model('E:\\Certificate\\Cources\\code\\Recommendationsystem\\models\\NutriTrack4545.h5')
...
train_data = train_datagen.flow_from_directory(
    'E:\\Certificate\\code\\Recommendationsystem\\dataset\\Indian Food Images\\Train',  # Change this to your actual training dataset path
    target_size=(224, 224),  
    batch_size=32,  
...
train_data = train_datagen.flow_from_directory('E:\\Certificate\\code\\Recommendationsystem\\dataset\\Indian Food Images\\Train', target_size=(224, 224), batch_size=32, class_mode='categorical')
